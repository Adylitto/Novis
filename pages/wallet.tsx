            ...
            <div className='row align-items-center'>
              <div className='col-lg-8 col-md-12'>
                <div className='tab-content' id='myTabContent'>
                  ...
                  >
                    <div className='box'>
                      ...
                      <ul className='features-list'>
                        <li>
                          <i className='bx bx-check'></i> You’re the custodian, you
                          have control
                        </li>
                      </ul>
                  ...
                  <div className='tab-pane fade' id='send-receive' role='tabpanel'>
                    <div className='box'>
                      ...
                      <ul className='features-list'>
                        <li>
                          <i className='bx bx-check'></i> We support bitcoin (BTC),
                          ether (ETH), bitcoin cash (BCH), stellar (XLM),
                  ...
                  >
                    <div className='box'>
                      ...
                      <ul className='features-list'>
                        <li>
                          <i className='bx bx-check'></i> Exchange crypto-to-crypto
                          instantly
                        </li>
                        <li>
                          <i className='bx bx-check'></i> Buy and sell supported in
                          100 countriesy
                        </li>
                      </ul>
                      <a href='login-register.html' className='default-btn'>
                  ...
                  >
                    <div className='box'>
                      ...
                      <ul className='features-list'>
                        ...
                        <li>
                          <i className='bx bx-check'></i> Available in 25 languages
                        </li>
                        <li>
